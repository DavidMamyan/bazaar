...
if (isset($_POST['srch'])) {
	...
	<form action="<?php echo $this->objUrl->getCurrent('srch'); ?>" method="POST">
		<table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
			<tr>
				<th><label for="srch">Order number</label></th>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
		...
		<tr>
			...
			<td class="ta_r">&#36;<?php echo number_format($order['total'], 2); ?></td>
			<td class="ta_r">
				<?php 
			...
			<td class="ta_r"><a href="<?php echo $this->objUrl->getCurrent('action').'/action/edit/id/'.$order['id'] ?>">View</a></td>
		</tr>
		<?php } ?>
	</table>
