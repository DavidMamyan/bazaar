...
Login::restrictFront($this->objUrl);
	...
	if (!empty($id)) { 
		...
		//if you wanna see the invoice page withouth successful submission from paypal, delete && Session::getSession(Login::$_login_front==$order['client'])
		if (!empty($order)) {
		...
		<body>
			<div id="wrapper">
				<h1>Invoice</h1>
			  	...
			  	<div class="dev">&#160;</div>
			  	<h3>Order number: <?php echo $id ?> / <?php echo $order['date']; ?></h3>
