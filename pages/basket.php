	...
	<div id="big_basket">
		<form action="" method="POST" id="frm_basket">
			<table cellpadding="0" border="0" cellspacing="0" class="tbl_repeat">
				...
				<?php foreach ($out as $item) { ?>
					<tr>
						...
						<td><input type="number" name="qty-<?php echo $item['id']; ?>" id="qty-<?php echo $item['id']; ?>" value="<?php echo $session[$item['id']]['qty'] ?>" class="fld_qty"></td>
			...
			<div class="sbm sbm_blue fl_r">
				<a href="<?php echo $this->objUrl->href('checkout');?>" class="btn">Ckechout</a>
			</div>
